                ...
                if (TEnum.class.isAssignableFrom(c)) { // enum
                    ...
                    FieldMetaData.getStructMetaDataMap((Class<? extends TBase>) c).forEach((key, value) -> {
                        ...
                        if (value.requirementType == TFieldRequirementType.OPTIONAL) {
                            Object defVal = instance.getFieldValue(key);
                            defaultValue = defVal == null ? NULL_DEFAULT_VALUE : defVal;
                            ...
                            defaultValue = instance.getFieldValue(key);
                            s = getSchema(value.valueMetaData, defaultValue != null);
                        }
    ...
    private Schema getSchema(FieldValueMetaData f, boolean hasNotNullDefaultValue) {
        switch (f.type) {
            ...
            case TType.LIST:
                ...
                return nullable(Schema.createArray(getSchema(listMeta.elemMetaData, hasNotNullDefaultValue)), hasNotNullDefaultValue);
            case TType.MAP:
                ...
                Schema map = Schema.createMap(getSchema(mapMeta.valueMetaData, hasNotNullDefaultValue));
            ...
            case TType.SET:
                ...
                Schema set = Schema.createArray(getSchema(setMeta.elemMetaData, hasNotNullDefaultValue));
