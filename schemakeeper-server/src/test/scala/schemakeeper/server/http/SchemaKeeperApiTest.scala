...
//      val result =
//        api.updateSubjectSettings(Input.put("/v2/subjects/A1").withBody[Application.Json](body)).awaitValueUnsafe()
//
...
//      val body = SubjectSettings(CompatibilityType.FORWARD, isLocked = true)
//      val result =
//        api.updateSubjectSettings(Input.put("/v2/subjects/A1").withBody[Application.Json](body)).awaitOutputUnsafe()
//
//      assertResult(
//        Output.failure(ErrorInfo(SubjectDoesNotExist("A1").msg, ErrorCode.SubjectDoesNotExistCode), Status.NotFound)
//      )(result.get)
...
//      assertResult(
//        Output.failure(
//          ErrorInfo(SubjectSchemaVersionDoesNotExist("A1", 2).msg, ErrorCode.SubjectSchemaVersionDoesNotExistCode),
//          Status.NotFound
//        )
//      )(result.get)
//    }
...
//      assertResult(
//        Output.failure(ErrorInfo(SchemaIdDoesNotExist(1).msg, ErrorCode.SchemaIdDoesNotExistCode), Status.NotFound)
//      )(result.get)
//    }
//
//    "throws validation error" in {
...
//      val api = SchemaKeeperApi(schemaStorage)
//      val result = api
//        .schemaIdBySubjectAndSchema(Input.post(s"/v2/subjects/A1/schemas/id").withBody[Application.Json](body))
//        .awaitValueUnsafe()
//
...
//      assertResult(
//        Output.failure(
//          ErrorInfo(SubjectIsNotConnectedToSchema("A1", id).msg, ErrorCode.SubjectIsNotConnectedToSchemaCode),
//          Status.BadRequest
//        )
//      )(result.get)
//    }
...
//        Output.failure(
//          ErrorInfo(
//            service.SubjectSchemaVersionDoesNotExist("A1", 123).msg,
...
//    "throws validation error" in {
//      val api = SchemaKeeperApi(schemaStorage)
//      assertThrows[NotValid](
//        api.deleteSubjectSchemaByVersion(Input.delete("/v2/subjects/A1/versions/-1")).awaitOutputUnsafe()
//      )
//    }
//  }
//
...
//          Input.post("/v2/subjects/A1/compatibility/schemas").withBody[Application.Json](body)
//        )
//        .awaitValueUnsafe()
//      assert(result.get)
//    }
...
//      val api = SchemaKeeperApi(schemaStorage)
//      val schema =
//        schemaStorage.registerSchema(Schema.create(Schema.Type.STRING).toString, SchemaType.AVRO).unsafeRunSync()
...
//        Output.failure(
//          ErrorInfo(
//            SchemaIsAlreadyExist(id, Schema.create(Schema.Type.STRING).toString()).msg,
