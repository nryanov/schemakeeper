...
public abstract class SchemaKeeperClient {
     ...
     */
    public abstract Optional<Schema> getSchemaById(int id);
     ...
     * @return - schema id
     */
    public abstract Optional<Integer> registerNewSchema(String subject, Schema schema, SchemaType schemaType, CompatibilityType compatibilityType);
     ...
     * @return - schema id
     */
    public abstract Optional<Integer> getSchemaId(String subject, Schema schema, SchemaType schemaType);
