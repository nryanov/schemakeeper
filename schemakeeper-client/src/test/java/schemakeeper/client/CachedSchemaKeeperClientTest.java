...
public class CachedSchemaKeeperClientTest {
    ...
    public void registerNewSchema() {
        ...
        assertEquals(id, client.getSubjectSchemas().get("A").get(Schema.create(Schema.Type.STRING)));
    ...
    public void registerMultipleSubjectsWithSimilarSchemas() {
        ...
        assertEquals(id, client.getSubjectSchemas().get("A1").get(Schema.create(Schema.Type.STRING)));

        int repeat = client.registerNewSchema("B1", Schema.create(Schema.Type.STRING), SchemaType.AVRO, CompatibilityType.BACKWARD);

        assertEquals(repeat, client.getSubjectSchemas().get("B1").get(Schema.create(Schema.Type.STRING)));
    ...
    public void registerMultipleSubjectsWithDifferentSchemas() {
        ...
        assertEquals(id, client.getSubjectSchemas().get("A2").get(Schema.create(Schema.Type.STRING)));

        int repeat = client.registerNewSchema("B2", Schema.create(Schema.Type.INT), SchemaType.AVRO, CompatibilityType.BACKWARD);

        assertEquals(repeat, client.getSubjectSchemas().get("B2").get(Schema.create(Schema.Type.INT)));
        assertEquals(2, client.getSubjectSchemas().size());
    ...
    public void registerSingleSubjectWithDifferentSchemas() {
        ...
        assertEquals(id, client.getSubjectSchemas().get("C").get(Schema.create(Schema.Type.STRING)));
    ...
    public void getSchemaId() {
        ...
        assertEquals(id, client1.getSubjectSchemas().get("E").get(Schema.create(Schema.Type.STRING)));
