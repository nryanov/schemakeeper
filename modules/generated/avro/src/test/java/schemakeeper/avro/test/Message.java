 ...
 */
package schemakeeper.avro.test;
...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"schemakeeper.avro.test\",\"fields\":[{\"name\":\"f1\",\"type\":\"long\"},{\"name\":\"f2\",\"type\":\"string\"},{\"name\":\"f3\",\"type\":\"long\"},{\"name\":\"f4\",\"type\":[\"null\",\"string\"]}]}");
   ...
   */
  public Message(java.lang.Long f1, java.lang.CharSequence f2, java.lang.Long f3, java.lang.CharSequence f4) {
    this.f1 = f1;
    this.f2 = f2;
    this.f3 = f3;
    this.f4 = f4;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: f3 = (java.lang.Long)value$; break;
    case 3: f4 = (java.lang.CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static schemakeeper.avro.test.Message.Builder newBuilder() {
    return new schemakeeper.avro.test.Message.Builder();
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static schemakeeper.avro.test.Message.Builder newBuilder(schemakeeper.avro.test.Message.Builder other) {
    if (other == null) {
      return new schemakeeper.avro.test.Message.Builder();
    } else {
      return new schemakeeper.avro.test.Message.Builder(other);
    }
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static schemakeeper.avro.test.Message.Builder newBuilder(schemakeeper.avro.test.Message other) {
    if (other == null) {
      return new schemakeeper.avro.test.Message.Builder();
    } else {
      return new schemakeeper.avro.test.Message.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(schemakeeper.avro.test.Message.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(schemakeeper.avro.test.Message other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.f1)) {
        this.f1 = data().deepCopy(fields()[0].schema(), other.f1);
    ...
    /**
      ...
      * @return This builder.
      */
    public schemakeeper.avro.test.Message.Builder setF1(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public schemakeeper.avro.test.Message.Builder clearF1() {
    ...
    /**
      ...
      * @return This builder.
      */
    public schemakeeper.avro.test.Message.Builder setF2(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public schemakeeper.avro.test.Message.Builder clearF2() {
      f2 = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public schemakeeper.avro.test.Message.Builder setF3(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public schemakeeper.avro.test.Message.Builder clearF3() {
    ...
    /**
      ...
      * @return This builder.
      */
    public schemakeeper.avro.test.Message.Builder setF4(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public schemakeeper.avro.test.Message.Builder clearF4() {
      f4 = null;
    ...
    public Message build() {
      try {
        ...
        record.f3 = fieldSetFlags()[2] ? this.f3 : (java.lang.Long) defaultValue(fields()[2]);
        record.f4 = fieldSetFlags()[3] ? this.f4 : (java.lang.CharSequence) defaultValue(fields()[3]);
        return record;
