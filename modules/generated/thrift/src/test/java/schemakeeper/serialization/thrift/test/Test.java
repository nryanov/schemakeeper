...
public class Test implements TBase<Test, Test._Fields>, java.io.Serializable, Cloneable, ThriftStructIface {
  ...
  public static List<String> validateNewInstance(Test item) {
    ...
    if (item.isSetStructField()) {
      ...
      buf.addAll(schemakeeper.serialization.thrift.test.Nested.validateNewInstance(_structField));
    }

    if (item.isSetFooOrBar()) {
      FooOrBar _fooOrBar = item.fooOrBar;
      buf.addAll(schemakeeper.serialization.thrift.test.FooOrBar.validateNewInstance(_fooOrBar));
    }
  ...
  public void read(TProtocol iprot) throws TException {
    ...
    while (true)
    {
      ...
      switch (field.id) {
        case 1: // BOOL_FIELD
          TProtocols.validateFieldType(TType.BOOL, field.type, "boolField");
          this.boolField = iprot.readBool();
          setBoolFieldIsSet(true);
          break;
        case 2: // BYTE_FIELD
          TProtocols.validateFieldType(TType.BYTE, field.type, "byteField");
          this.byteField = iprot.readByte();
          setByteFieldIsSet(true);
          break;
        case 16: // BYTE_OPTIONAL_FIELD
          TProtocols.validateFieldType(TType.BYTE, field.type, "byteOptionalField");
          this.byteOptionalField = iprot.readByte();
          setByteOptionalFieldIsSet(true);
          break;
        case 3: // I16_FIELD
          TProtocols.validateFieldType(TType.I16, field.type, "i16Field");
          this.i16Field = iprot.readI16();
          setI16FieldIsSet(true);
          break;
        case 15: // I16_OPTIONAL_FIELD
          TProtocols.validateFieldType(TType.I16, field.type, "i16OptionalField");
          this.i16OptionalField = iprot.readI16();
          setI16OptionalFieldIsSet(true);
          break;
        case 4: // I32_FIELD
          TProtocols.validateFieldType(TType.I32, field.type, "i32Field");
          this.i32Field = iprot.readI32();
          setI32FieldIsSet(true);
          break;
        case 5: // I64_FIELD
          TProtocols.validateFieldType(TType.I64, field.type, "i64Field");
          this.i64Field = iprot.readI64();
          setI64FieldIsSet(true);
          break;
        case 6: // DOUBLE_FIELD
          TProtocols.validateFieldType(TType.DOUBLE, field.type, "doubleField");
          this.doubleField = iprot.readDouble();
          setDoubleFieldIsSet(true);
          break;
        case 7: // STRING_FIELD
          TProtocols.validateFieldType(TType.STRING, field.type, "stringField");
          this.stringField = iprot.readString();
          break;
        case 17: // STRING_OPTIONAL_FIELD_WITH_DEFAULT
          TProtocols.validateFieldType(TType.STRING, field.type, "stringOptionalFieldWithDefault");
          this.stringOptionalFieldWithDefault = iprot.readString();
          break;
        case 8: // BINARY_FIELD
          TProtocols.validateFieldType(TType.STRING, field.type, "binaryField");
          this.binaryField = iprot.readBinary();
          break;
        case 9: // MAP_FIELD
          TProtocols.validateFieldType(TType.MAP, field.type, "mapField");
          {
          ...
          break;
        case 10: // LIST_FIELD
          TProtocols.validateFieldType(TType.LIST, field.type, "listField");
          {
          ...
          break;
        case 11: // SET_FIELD
          TProtocols.validateFieldType(TType.SET, field.type, "setField");
          {
          ...
          break;
        case 12: // ENUM_FIELD
          TProtocols.validateEnumFieldType(field.type, "enumField");
          this.enumField = schemakeeper.serialization.thrift.test.E.findByValue(iprot.readI32());
          break;
        case 13: // STRUCT_FIELD
          TProtocols.validateFieldType(TType.STRUCT, field.type, "structField");
          this.structField = new Nested();
            this.structField.read(iprot);
          break;
        case 14: // FOO_OR_BAR
          TProtocols.validateFieldType(TType.STRUCT, field.type, "fooOrBar");
