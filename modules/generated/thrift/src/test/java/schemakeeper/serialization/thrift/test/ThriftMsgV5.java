...
public class ThriftMsgV5 implements TBase<ThriftMsgV5, ThriftMsgV5._Fields>, java.io.Serializable, Cloneable, ThriftStructIface {
    ...
    while (true)
    {
      ...
      switch (field.id) {
        ...
        case 3: // F3
          ...
          break;
        case 4: // F4
          TProtocols.validateFieldType(TType.STRING, field.type, "f4");
