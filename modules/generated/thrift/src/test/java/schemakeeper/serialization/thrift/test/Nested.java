...
public class Nested implements TBase<Nested, Nested._Fields>, java.io.Serializable, Cloneable, ThriftStructIface {
  ...
  public void read(TProtocol iprot) throws TException {
    ...
    while (true)
    {
      ...
      switch (field.id) {
        case 1: // X
          TProtocols.validateFieldType(TType.I32, field.type, "x");
