...
public class ThriftMsgV1 implements TBase<ThriftMsgV1, ThriftMsgV1._Fields>, java.io.Serializable, Cloneable, ThriftStructIface {
  ...
  public void read(TProtocol iprot) throws TException {
    ...
    while (true)
    {
      ...
      switch (field.id) {
        case 1: // F1
          TProtocols.validateFieldType(TType.STRING, field.type, "f1");
          this.f1 = iprot.readString();
          break;
        case 2: // F2
          TProtocols.validateFieldType(TType.STRING, field.type, "f2");
